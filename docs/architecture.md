...
- `apps/api`: Fastify HTTP server and webhook gateway.
- `apps/worker`: pg-boss background recovery worker.
- `apps/web`: React + Vite + Tailwind + TanStack Query merchant command center.
